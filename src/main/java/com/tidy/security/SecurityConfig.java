package com.tidy.security;

import com.tidy.service.UsuarioDetailsService;
...
public class SecurityConfig {
    ...
    public SecurityConfig(JwAuthFilter jwAuthFilter, UsuarioDetailsService usuarioDetailsService) {
